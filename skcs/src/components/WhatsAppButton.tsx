    ...
    return (
      <>
        ...
        <a
          ...
          target="_blank"
          rel="noopener noreferrer"
          className="fixed bottom-16 right-6 z-50 bg-blue-500 text-white p-4 rounded-full shadow-lg hover:bg-blue-600 transition-all duration-300 hover:scale-110 ml-4"
